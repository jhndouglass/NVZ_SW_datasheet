...
There `r fail.count.text` in the waterbody that designates this NVZ, and `r fail.count.text.upstream1` in the entire upstream designated NVZ. Figure 3 shows the time series of concentrations for the most polluted sample point in the designating waterbody.
...
SIMCAT is a well-established river water quality model with a long history of use in the UK. It has recently been developed to allow apportionment of a range of pollutants to various sectors, including agriculture.
...
## Landuse within the designation
...
The purpose the workshops was to discuss any proposed NVZ designations where the evidence supporting designation was uncertain or contrdictory, or where there were new or modified designations. We were not able to discuss every designation, but where discussion did take place abridged notes are provided below.
